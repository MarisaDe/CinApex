...
INSERT INTO `account` VALUES ('1','2006-10-01','Unlimited-2','444-44-4444'),('2','2006-10-15','limited','222-22-2222'),('3','2006-09-23','Unlimited-3','333-33-3333');
...
--
-- Temporary table structure for view `countorders`
--
...
--
-- Temporary table structure for view `monthlyreport`
--
...
INSERT INTO `movie` VALUES (1,'The GodFather','Drama',5,10000,2),(2,'Shawshank Redemption','Drama',2,1000,1),(3,'S','Horror',5,2,10),(5,'Departed','Drama',5,5000,2),(7,'New Name','Horror',2,2000,3);
...
INSERT INTO `movieq` VALUES ('1',1),('2',1),('1',2),('2',2),('1',5),('2',5);
...
--
-- Temporary table structure for view `orderlist`
--
...
INSERT INTO `userratings` VALUES ('222-22-2222',2,NULL),('222-22-2222',5,NULL),('444-44-4444',1,NULL),('444-44-4444',2,2);
...
-- Dump completed on 2017-05-04  6:28:07
